...
{
    // Crear empleados
    Empleado Empleado1("gerente", 2.500, "10", "luis", "lara", "22997412", "10/11/90", 40);
    Empleado Empleado2("Anlista", 950, "5", "lia", "Lopez", "228874", "2/7/80");
    Empleado Empleado3("Investigador", 5000, "8", "alex", "requejo", "2244578", "5/10/95", 24);
    Empleado Empleado4("Contador", 5412, "4", "roger", "acharte", "254754", "8/1/97", 20);
    Empleado Empleado5("Abogado", 4121, "8", "martin", "Ugarte", "4545421", "5/10/95", 27);
    Empleado Empleado6("Secretaria", 4000, "2", "Joel", "Herrera", "2245785", "5/10/95", 30);
    ...
    Empleado Empleado9("Economista", 1000, "6", "danny", "espinoza", "224785", "2/15/95", 19);
    Empleado Empleado10("Enfermera", 5500, "7", "hernand", "mariano", "214653", "6/24/79", 40);

...
public:
    ...
    string toString()
    {
        string resumen = "cilindradas" + cilindrica_motor + "numero de asientos" + to_string(nun_asientos) + " numero de ruedas" + to_string(num_ruedas) + " numeros de ruedas" +to_string (num_puertas) + "certicado de seguridad" + to_string(certificacion_seguridad);
